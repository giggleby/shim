...
DOCKER_IMAGE_GITHASH="adb3ce05745d5a319affecf2ee7c286447f28492"
DOCKER_IMAGE_TIMESTAMP="20230616101859"
...
do_umpire_run() {
  ...
  local umpire_dkps_port=$((umpire_base_port + 9))
