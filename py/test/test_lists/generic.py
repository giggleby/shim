...
class TestListArgs(object):
  ...
  # Warning duration when AC is abnormal before stopping the test.
  run_in_countdown_ac_secs = 30
  # Expected AC type.
  run_in_countdown_ac_type = 'Mains'
