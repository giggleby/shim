...
class CLICommand(umpire_rpc.UmpireRPC):
  ...
  @umpire_rpc.RPCCall
  def AddPayload(self, file_path, payload_type):
    ...
    """
    return self.env.AddPayload(file_path, payload_type)

  @umpire_rpc.RPCCall
  def AddConfig(self, file_path, config_type):
    ...
    Returns:
      Resource file name.
    """
    return self.env.AddConfig(file_path, config_type)

  @umpire_rpc.RPCCall
  def AddConfigFromBlob(self, blob, config_type):
    """Adds a config file into <base_dir>/resources.
    ...
    Returns:
      Resource file name.
    """
    return self.env.AddConfigFromBlob(blob, config_type)
